...
//  }
  ...
  while(loc_idx < nof_location){
      ...
      for(int i=0;i<15;i++){
        ...
        if(dci_location[loc_idx].checked || dci_location[loc_idx].mean_llr < LLR_RATIO){
...
//
  ...
  //srsran_ngscope_tree_prune_tree(dci_array, nof_location);
