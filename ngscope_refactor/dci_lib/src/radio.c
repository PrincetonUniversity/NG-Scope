...
// init the Radio structure and at the same time start the SDR -- USRP here
// input prog_args_t -- the configurations of the ngscope
//       cell_search_cfg_t --- the cell search configurations
// output srsran_rf_t -- the radio struct
//        srsran_cell_t --- the cell info
//        float --- CFO estimated
